package net.eelan.arkbreedhelper.web.rest;

import static net.eelan.arkbreedhelper.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.eelan.arkbreedhelper.ArkBreedHelperApp;
import net.eelan.arkbreedhelper.config.Constants;
import net.eelan.arkbreedhelper.domain.User;
import net.eelan.arkbreedhelper.repository.AuthorityRepository;
import net.eelan.arkbreedhelper.repository.UserRepository;
import net.eelan.arkbreedhelper.security.AuthoritiesConstants;
import net.eelan.arkbreedhelper.service.UserService;
import net.eelan.arkbreedhelper.service.dto.PasswordChangeDTO;
import net.eelan.arkbreedhelper.service.dto.UserDTO;
import net.eelan.arkbreedhelper.web.rest.vm.KeyAndPasswordVM;
import net.eelan.arkbreedhelper.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = ArkBreedHelperApp.class)
